...
Coinbase::Client.autoload :BroadcastSendRequest, 'coinbase/client/models/broadcast_send_request'
...
Coinbase::Client.autoload :CreateSendRequest, 'coinbase/client/models/create_send_request'
...
Coinbase::Client.autoload :ModelSend, 'coinbase/client/models/model_send'
...
Coinbase::Client.autoload :SendList, 'coinbase/client/models/send_list'
...
Coinbase::Client.autoload :SendsApi, 'coinbase/client/api/sends_api'
