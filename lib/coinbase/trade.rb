...
module Coinbase
  ...
  class Trade
    # A representation of a Trade status.
    module Status
      # The Trade is awaiting being broadcast to the Network. At this point, transaction
      # hashes may not yet be assigned.
      PENDING = 'pending'

      # The Trade has been broadcast to the Network. At this point, at least the transaction hash
      # should be assigned.
      BROADCAST = 'broadcast'

      # The Trade is complete, and has confirmed on the Network.
      COMPLETE = 'complete'

      # The Trade has failed for some reason.
      FAILED = 'failed'
    end
