...
module Coinbase
  ...
  class SmartContract
    class << self
      ...
      # smart_contract.read(method: 'balanceOf', args: { 'owner': '0x1234' })
    ...
    def sign(key)
      ...
      raise 'Cannot sign for an external smart contract' unless transaction
    ...
    def deploy!
      raise 'Cannot deploy an external smart contract' unless transaction
    ...
    def wait!(interval_seconds = 0.2, timeout_seconds = 20)
      raise 'Cannot wait for an external smart contract' unless transaction
    ...
    def smart_contracts_api
      @smart_contracts_api ||= self.class.smart_contracts_api
    end
  end
end
