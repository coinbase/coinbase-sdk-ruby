...
module Coinbase
  ...
  class SmartContract
    ...
    def self.list_events(network_id, protocol_name, contract_address, contract_name, event_name, from_block_height, to_block_height)
      Coinbase::Pagination.enumerate(
        ->(page) { list_events_page(network_id, protocol_name, contract_address, contract_name, event_name, from_block_height, to_block_height, page) }
      ) do |contract_event|
    ...
    def to_s
      "Coinbase::SmartContract{network_id: '#{network_id}', protocol_name: '#{protocol_name}', contract_name: '#{contract_name}', address: '#{address}'}"
    end
    ...
    def self.list_events_page(network_id, protocol_name, contract_address, contract_name, event_name, from_block_height, to_block_height, page)
